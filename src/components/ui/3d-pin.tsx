    ...
    >
      ...
      >
        <div
          ...
          className="absolute left-1/2 top-1/2 flex items-start justify-start overflow-hidden rounded-2xl border border-white bg-white p-1 shadow-[0_8px_16px_rgb(0_0_0/0.4)] transition duration-700 group-hover/pin:border-white/[0.2]"
        >
          ...
          <div className="relative z-10 flex items-center space-x-2 px-4 py-0.5">
            <span className="relative z-20 inline-block h-[22rem] w-[22rem] py-0.5 text-xs font-bold text-white">
              <span className="absolute inset-0 h-full w-full -rotate-45 overflow-clip backdrop-sepia-0">
                {pinChild}
                <span className="absolute inset-0 -z-10 border-b-2 border-l-2 border-white opacity-45 shadow-2xl"></span>
              </span>
            </span>
          </div>
        </div>
