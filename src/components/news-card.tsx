...
export default function NewsCard({ props }: Props) {
  ...
  return (
    <Card className="group relative border border-gray-600 bg-white bg-opacity-5 bg-none px-4 shadow-[0_10px_45px_1px_rgba(0,0,0,0.4)] backdrop-blur-xl transition-all duration-300 ease-in-out">
      ...
      <CardContent className="relative pb-20">
        <div className="relative overflow-hidden">
          ...
          />
          <div className="absolute bottom-1 left-[50%] h-[20px] w-[30%] -translate-x-1/2 transform rounded-xl bg-black opacity-60 blur-sm transition-all duration-300 ease-in-out group-hover:w-[40%] group-hover:blur-md"></div>
        </div>
      </CardContent>
