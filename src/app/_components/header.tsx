...
export default function Header() {
  return (
    <header className="static sticky top-4 isolate z-50 mx-2 mt-4 flex h-16 items-center justify-between gap-4 border border-gray-600 bg-white bg-opacity-5 px-4 shadow-[0_10px_45px_1px_rgba(0,0,0,0.4)] backdrop-blur-xl md:px-6">
