...
export default function Header() {
  return (
    <header className="relative sticky top-4 mx-2 mt-4 flex h-16 items-center justify-between gap-4 border border-gray-600 bg-white bg-opacity-5 px-4 shadow-[0_10px_45px_1px_rgba(0,0,0,0.4)] backdrop-blur-xl md:px-6">
      {/* White Corners */}
      <div className="pointer-events-none absolute inset-0 z-0 before:absolute before:-left-[2px] before:-top-[2px] before:h-2 before:w-2 before:border-l-2 before:border-t-2 before:border-white before:content-[''] after:absolute after:-right-[2px] after:-top-[2px] after:h-2 after:w-2 after:border-r-2 after:border-t-2 after:border-white after:content-['']">
